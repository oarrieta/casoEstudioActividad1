			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="mueble" title="${message(code: 'producto.mueble.label', default: 'Mueble')}" />
					
						<g:sortableColumn property="precio" title="${message(code: 'producto.precio.label', default: 'Precio')}" />
					
						<g:sortableColumn property="productoElectrico" title="${message(code: 'producto.productoElectrico.label', default: 'Producto Electrico')}" />
				...
				<g:each in="${productoInstanceList}" status="i" var="productoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatBoolean boolean="${productoInstance.mueble}" /></td>
					
						<td>${fieldValue(bean: productoInstance, field: "precio")}</td>
					
						<td><g:formatBoolean boolean="${productoInstance.productoElectrico}" /></td>
